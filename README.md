...
**Doc My A$$** is the developer-first documentation system and WordPress plugin for the **Security Sentinel Suite** (`securemyass.com`).
...
6. **Sentinel API & Platform** (`sentinel-api`): Swarm threat intelligence telemetry, licensing lifecycle, auto-updates.
